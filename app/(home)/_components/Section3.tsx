    ...
    <section className=" relative z-40 container">
      ...
      <div className=" flex flex-col lg:grid pt-12  pb-6 lg:grid-cols-12 gap-8">
        <div className="col-span-12 lg:col-span-8 grid gap-8 lg:grid-cols-2">
          <div className="border p-2 bg-cover bg-no-repeat border-[#393939] hover:bg-[url('/Section-3/Card-Background.png')] hover:border-[#3F61C1]">
            <div className=" group-hover:border h-full border-[#3F61C1]  bg-black px-10 py-16 flex flex-col gap-y-8">
              <div>
                <svg
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="text-3xl lg:max-w-[85%] font-bold bg-clip-text bg-headingText">
          ...
          <div className="border p-2 bg-cover bg-no-repeat border-[#393939] hover:bg-[url('/Section-3/Card-Background.png')] hover:border-[#3F61C1]">
            <div className=" group-hover:border h-full border-[#3F61C1]  bg-black px-10 py-16 flex flex-col gap-y-8">
              ...
              <div className="space-y-3">
                <div>
                  <h3 className="text-3xl lg:max-w-[85%] font-bold bg-clip-text bg-headingText">
                    Effortless <br className="hidden lg:block" /> Transfers
                  </h3>
                </div>
                <p className="text-base font-normal text-[#E5E5E5]">
                  Experience ultra-fast, low-fee asset transfers designed for
                  the modern trader.
                </p>
              </div>
            </div>
        ...
        <div className="border p-2 min-h-[800px] relative col-span-12 lg:col-span-4 bg-cover bg-no-repeat border-[#393939] hover:bg-[url('/Section-3/Card-Background.png')] hover:border-[#3F61C1]">
          <div className="group-hover:border h-full border-[#3F61C1]  bg-black px-10 py-16 flex flex-col gap-y-8 ">
            <div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
